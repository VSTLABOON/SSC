// HistorialReporteDA.tsx
import { useEffect, useRef, useState } from 'react';
import './HistorialReporteDA.css';
import foto_directivo from '../../assets/imagenes/foto_maestro.jpg';
import SCTechlogo from '../../assets/imagenes/SCTechlogo.png';

// ── Types ──────────────────────────────────────────────────────────────────

// Pantallas del menú oficial de Directivos/Asesores.
...
interface HistorialReporteDAProps {
...
// ── Component ──────────────────────────────────────────────────────────────
export default function HistorialReporteDA({ onNavigate }: HistorialReporteDAProps) {

  // ── Sidebar state (copiado del menú oficial) ─────────────────────────────
  ...
  function handleNavigate(screen: DAScreen): void {
  ...
  function handleLogout(): void { handleNavigate('login'); }
  function handleInstitutionLogoClick(): void { console.log('Logo institucional'); }

  // ── Dynamic classes (mismo patrón que el resto del módulo) ───────────────
  ...
  return (
    <div className="hrm-body">
      ...
      {/* ── Sidebar (menú oficial, 3 opciones) ────────────────────────────── */}
        ...
        <div className="grm-sidebar-top">
          ...
          <div className="grm-teacher-card">
            ...
            <div className="grm-teacher-card-avatar">
              <img alt="Andrew Mike" className="grm-teacher-card-avatar-img" src={foto_directivo} />
            </div>
            <div>
              <p className="grm-teacher-card-name">Andrew Mike</p>
              <p className="grm-teacher-card-role">Directivo/Asesor</p>
            </div>
          </div>
        </div>

        <nav className="grm-sidebar-nav">
          <a className="grm-nav-item" href="#" onClick={() => handleNavigate('InicioDA')}>
            <span className="material-symbols-outlined">dashboard</span>
            <span className="grm-nav-item-label">Inicio</span>
          </a>
          <a className="grm-nav-item" href="#" onClick={() => handleNavigate('GenerarReporteDA')}>
            <span className="material-symbols-outlined">assessment</span>
            <span className="grm-nav-item-label">Generar Reporte</span>
          </a>
          <a className="grm-nav-item grm-nav-item--active" href="#" onClick={() => handleNavigate('Historialreporteda')}>
      ...
      <main className="hrm-main">
        ...
        {/* TopBar (exact copy del menú oficial) */}
